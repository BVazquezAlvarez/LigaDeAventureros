    ...
    <table class="table table-hover">
        ...
        <tbody>
            <? foreach ($characters as $char) : ?>
                <tr class="js-all-characters-search <?= $char->user_uid == $userdata['uid'] ? 'table-warning' : '' ?>" data-query="<?= strtolower($char->name) ?> <?= strtolower($char->display_name) ?> <?= strtolower($char->class) ?> <?= $char->level ?> <?= strtolower(rank_name(rank_get($char->level))) ?>">

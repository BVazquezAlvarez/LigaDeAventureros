...
<form method="post" action="<?= base_url('new-character') ?>" enctype="multipart/form-data">
    ...
    <section id="section-class" class="new-character-guide-section" style="display:none;">
        ...
        <p>
            Si has elegido empezar a nivel 5, también puedes optar por crear un personaje multiclase, pero no es recomendable para nuevos jugadores, ya que sin un plan claro suele dar lugar a personajes considerablemente más débiles.
        </p>
        <div class="form-group">

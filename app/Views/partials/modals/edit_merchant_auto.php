...
<div class="modal fade" id="edit-automatic-merchant-modal" tabindex="-1">
    <form class="modal-dialog modal-dialog-centered" method="post" action="<?= base_url('admin/edit-automatic-merchant') ?>" enctype="multipart/form-data">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Editar mercader</h5>
